...
export abstract class BaseProvider implements ProviderInfo {
  ...
  cachedDynamicModels?: { cacheId: string; models: ModelInfo[] };
...
export function getOpenAILikeModel(baseURL: string, apiKey: OptionalApiKey, model: string): LanguageModelV1 {
