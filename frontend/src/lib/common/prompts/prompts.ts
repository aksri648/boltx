...
<system_constraints>
  You are operating in a Daytona cloud sandbox — a full Linux VM environment running on cloud infrastructure.
...
<mobile_app_instructions>
  ...
  IMPORTANT: React Native and Expo are supported mobile frameworks in the sandbox.
